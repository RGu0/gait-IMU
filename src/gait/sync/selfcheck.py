...
| --- | --- | --- | --- | --- | --- | --- |
| 108 | 555 ms | 0.00 | 0.00 | 0.00 | 500~600 ms | −1111 ms |
...
所以**在本模块的工作区间里这个配法是精确的**：PRD §8 的容差上界是 30 ms，
`selfcheck_offset_warn_s` 是 50 ms，而失效点在 375~555 ms —— 隔着 7~18 倍。
